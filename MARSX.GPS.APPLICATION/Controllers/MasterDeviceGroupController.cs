...
using MARSX.GPS.APPLICATION.Repositories.MasterDeviceGroupRepositories;
...
{
    public class MasterDeviceGroupController : Controller
    {
        IConfiguration _configuration;

        private readonly IMasterDeviceGroupRepositories _repoCollection;

        public MasterDeviceGroupController(IConfiguration configuration)
        {
            _configuration = configuration;

            _repoCollection = new MasterDeviceGroupRepositories(configuration);
        ...
        public async Task<IActionResult> Get(MasterDeviceGroupFilter param)
        {
        ...
        public async Task<IActionResult> Create(MasterDeviceGroup param)
        {
            Response resp = new Response();
        ...
        public async Task<IActionResult> Update(MasterDeviceGroup param)
        {
            Response resp = new Response();

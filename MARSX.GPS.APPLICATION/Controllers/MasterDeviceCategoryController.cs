...
using MARSX.GPS.APPLICATION.Repositories.MasterDeviceCategoryRepositories;
...
{
    public class MasterDeviceCategoryController : Controller
    {
        IConfiguration _configuration;

        private readonly IMasterDeviceCategoryRepositories _repoCollection;


        public MasterDeviceCategoryController(IConfiguration configuration)
        {
            _configuration = configuration;

            _repoCollection = new MasterDeviceCategoryRepositories(configuration);
        ...
        public async Task<IActionResult> Get(MasterDeviceCategoryFilter param)
        {
        ...
        public async Task<IActionResult> Create(MasterDeviceCategory param)
        {
            Response resp = new Response();
        ...
        public async Task<IActionResult> Update(MasterDeviceCategory param)
        {
            Response resp = new Response();

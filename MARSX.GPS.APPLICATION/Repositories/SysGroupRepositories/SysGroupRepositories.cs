...
namespace MARSX.GPS.APPLICATION.Repositories.SysGroupRepositories
{
    public class SysGroupRepositories : ISysGroupRepositories
    {
        ...
        public SysGroupRepositories(IConfiguration configuration)
        {
        ...
        public async Task<Response> Get(SysGroupFilter param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/SysGroup/Get?" + queryString);
                ...
                if (resp.effectRow > 0)
                {
                    resp.data = JsonConvert.DeserializeObject<List<SysGroup>>(resp.data.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response> Detail(int id)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/SysGroup/Get?id=" + id);
                ...
                if (resp.effectRow > 0)
                {
                    resp.data = JsonConvert.DeserializeObject<SysGroup>(resp.data.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response> Create(SysGroup param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/SysGroup/Create/");
        ...
        public async Task<Response> Update(SysGroup param)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_domain + $"api/SysGroup/");

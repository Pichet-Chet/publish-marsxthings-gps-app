...
namespace MARSX.GPS.API.Controllers
{
    ...
    {
        private readonly ISysUserRepositories repoCollection;

        public SysUserController()
        {
            repoCollection = new SysUserRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] SysUserFilter param)
        {
        ...
        [Route("Create")]
        //[Authorize]
        public async Task<IActionResult> Create([FromBody] SysUser param)
        {
            Response result = new Response();
        ...
        [Route("Update")]
        //[Authorize]
        public async Task<IActionResult> Update([FromBody] SysUser param)
        {
            Response result = new Response();
        ...
        //[Authorize]
        public async Task<IActionResult> UpdatePassCode([FromBody] SysUser param)
        {
            Response result = new Response();
            ...
            try
            {
                ...
                result = await Task.Run(() => repoCollection.UpdatePassCode(param));

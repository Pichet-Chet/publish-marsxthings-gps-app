...
using MARSX.GPS.API.Repositories.MasterDeviceStatusRepositories;
...
namespace MARSX.GPS.API.Controllers
{
    ...
    [ApiController]
    public class MasterDeviceStatusController : ControllerBase
    {
        private readonly IMasterDeviceStatusRepositories repoCollection;

        public MasterDeviceStatusController()
        {
            repoCollection = new MasterDeviceStatusRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] MasterDeviceStatusFilter param)
        {
        ...
        [Route("Create")]
        //[Authorize]
        public async Task<IActionResult> Create([FromBody] MasterDeviceStatus param)
        {
            Response result = new Response();
        ...
        [Route("Update")]
        //[Authorize]
        public async Task<IActionResult> Update([FromBody] MasterDeviceStatus param)
        {
            Response result = new Response();

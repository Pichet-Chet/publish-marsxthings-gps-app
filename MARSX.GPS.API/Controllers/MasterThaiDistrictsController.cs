...
using MARSX.GPS.API.Repositories.MasterThaiDistrictsRepositories;
...
namespace MARSX.GPS.API.Controllers
{
    ...
    [ApiController]
    public class MasterThaiDistrictsController : Controller
    {
        private readonly IMasterThaiDistrictsRepositories repoCollection;

        public MasterThaiDistrictsController()
        {
            repoCollection = new MasterThaiDistrictsRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] MasterThaiDistrictFilter param)
        {

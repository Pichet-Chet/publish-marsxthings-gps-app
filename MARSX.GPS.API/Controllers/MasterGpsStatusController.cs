...
using MARSX.GPS.API.Repositories.MasterGpsStatusRepositories;
...
namespace MARSX.GPS.API.Controllers
{
    ...
    [ApiController]
    public class MasterGpsStatusController : ControllerBase
    {
        private readonly IMasterGpsStatusRepositories repoCollection;

        public MasterGpsStatusController()
        {
            repoCollection = new MasterGpsStatusRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] MasterGpsStatusFilter param)
        {
        ...
        [Route("Create")]
        //[Authorize]
        public async Task<IActionResult> Create([FromBody] MasterGpsStatus param)
        {
            Response result = new Response();
        ...
        [Route("Update")]
        //[Authorize]
        public async Task<IActionResult> Update([FromBody] MasterGpsStatus param)
        {
            Response result = new Response();

...
using MARSX.GPS.API.Repositories.MasterDeviceCategoryRepositories;
...
namespace MARSX.GPS.API.Controllers
{
    ...
    [ApiController]
    public class MasterDeviceCategoryController : ControllerBase
    {
        private readonly IMasterDeviceCategoryRepositories repoCollection;

        public MasterDeviceCategoryController()
        {
            repoCollection = new MasterDeviceCategoryRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] MasterDeviceCategoryFilter param)
        {
        ...
        [Route("Create")]
        //[Authorize]
        public async Task<IActionResult> Create([FromBody] MasterDeviceCategory param)
        {
            Response result = new Response();
        ...
        [Route("Update")]
        //[Authorize]
        public async Task<IActionResult> Update([FromBody] MasterDeviceCategory param)
        {
            Response result = new Response();

...
using MARSX.GPS.API.Repositories.MasterGpsProviderRepositories;
...
namespace MARSX.GPS.API.Controllers
{
    ...
    [ApiController]
    public class MasterGpsProviderController : ControllerBase
    {
        private readonly IMasterGpsProviderRepositories repoCollection;

        public MasterGpsProviderController()
        {
            repoCollection = new MasterGpsProviderRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] MasterGpsProviderFilter param)
        {
        ...
        [Route("Create")]
        //[Authorize]
        public async Task<IActionResult> Create([FromBody] MasterGpsProvider param)
        {
            Response result = new Response();
        ...
        [Route("Update")]
        //[Authorize]
        public async Task<IActionResult> Update([FromBody] MasterGpsProvider param)
        {
            Response result = new Response();

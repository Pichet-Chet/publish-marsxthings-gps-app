...
namespace MARSX.GPS.API.Controllers
{
    ...
    {
        private readonly IMasterCountryRepositories repoCollection;

        public MasterCountryController()
        {
            repoCollection = new MasterCountryRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] MasterThaiDistrictsFilter param)
        {

...
using MARSX.GPS.API.Repositories.SysDeviceFavoriteRepositories;
...
namespace MARSX.GPS.API.Controllers
{
    ...
    {
        private readonly ISysDeviceFavoriteRepositories repoCollection;

        public SysDeviceFavoriteController()
        {
            repoCollection = new SysDeviceFavoriteRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] SysDeviceFavoriteFilter param)
        {
        ...
        [Route("Create")]
        //[Authorize]
        public async Task<IActionResult> Create([FromBody] SysDeviceFavorite param)
        {
            Response result = new Response();
        ...
        [Route("Update")]
        //[Authorize]
        public async Task<IActionResult> Update([FromBody] SysDeviceFavorite param)
        {
            Response result = new Response();
        ...
        [Route("Delete")]
        //[Authorize]
        public async Task<IActionResult> Delete([FromBody] SysDeviceFavorite param)
        {
            Response result = new Response();
            ...
            try
            {
                ...
                result = await Task.Run(() => repoCollection.Delete(param));

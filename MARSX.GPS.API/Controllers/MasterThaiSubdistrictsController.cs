...
using MARSX.GPS.API.Repositories.MasterThaiSubdistrictsRepositories;
...
namespace MARSX.GPS.API.Controllers
{
    ...
    [ApiController]
    public class MasterThaiSubdistrictsController : Controller
    {
        private readonly IMasterThaiSubdistrictsRepositories repoCollection;

        public MasterThaiSubdistrictsController()
        {
            repoCollection = new MasterThaiSubdistrictsRepositories();
        }
        ...
        [Route("Get")]
        //[Authorize]
        public async Task<IActionResult> Get([FromQuery] MasterThaiSubdistrictFilter param)
        {

...
{
    public class SysGroupRepositories : ISysGroupRepositories
    {
        private readonly TrackerContext _context;

        private readonly SysGroupService service;

        public SysGroupRepositories()
        {
            _context = new TrackerContext();

            service = new SysGroupService(_context);
        }

        public async Task<Response> Get(SysGroupFilter param)
        {
